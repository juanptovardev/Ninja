# 🏭 Fábrica de Ideas: Space Exploration Analytics
> Motor generativo para expandir sub-nichos o pivotar proyectos dentro de Space Exploration Analytics.
...
```text
Eres un Experto Arquitecto de Producto Ninja v3.4. Genera 5 ideas hiper-especializadas para el nicho de Space Exploration Analytics. 
