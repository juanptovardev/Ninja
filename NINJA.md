...
- **Library:** 200+ professional repos indexed in `lib/` (massively amplified with Web Native and Enterprise Dashboard elites).
...
- **3D & Especiales**: `Three.js` (Canvas), `Godogen` (Texturas y QA), `Color Expert` (Paletas Oklch).
