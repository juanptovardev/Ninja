...
## 🛠️ /ninja-init: Smart Scaffolding
Scaffold professional SaaS projects instantly with automated directory creation.
- `/ninja-init saas`: Injects Open-SaaS Deep Architecture.
- `/ninja-init ai`: Inyecta el Vercel AI SDK + Agentic patterns.
- `/ninja-init fullstack`: Inicializa Next.js 15 + Hono + Drizzle.
