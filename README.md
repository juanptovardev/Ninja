...
**Versión Actual:** v3.3 (Systematic Expansion)
...
1. Copia o clona esta estructura en la raíz de la carpeta de trabajo donde desarrollarás tu software.
2. Pídele a tu IA de preferencia (Cursor, Claude Code, OpenCode, Antigravity) que lea el archivo `NINJA.md` como instrucción de sistema global (`/ninja`).
